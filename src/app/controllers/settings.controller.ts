...
import { SettingsAppModel, SettingsAppType } from '../models/settings-app.model';
...
async function updateAppHandler(updatedApp: SettingsAppType) {
  await settingsAppModel.updateApp(updatedApp);
}
